...
class Login extends React.Component {
        ...
        dispatch({
          ...
          payload: {
            ...
            cb: (type, tips) => {
              ...
              window.localStorage.setItem("isLogin", type === 1);
            },
          },
        });
        // fetch(LOGIN_API, {
  ...
  renderSysTitle() {
    return <h2 className={styles.sysTitle}>OBE课程支撑平台</h2>;
  }
  ...
  renderLoginForm() {
    ...
    return (
      ...
      >
        ...
        <FormItem>
          <Button type="default" htmlType="submit" className={styles.loginBtn}>
            登陆
          </Button>
        </FormItem>
      </Form>
  ...
  render() {
    return <div className={styles.loginWrap}>{this.renderLogin()}</div>;
  }
}
